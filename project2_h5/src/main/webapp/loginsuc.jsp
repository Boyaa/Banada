...
<body style="
    ...
    text-align: center;">
       <section style="border-radius:25px; border:2px solid #eaeaea; padding:50px;">
        ...
        <div>
         <h1 style="font-family:ibm; font-size:40px; color:#ffc107;">로그인 성공!</h1>  
         </div>
       
        <div style="font-size:20px; margin-bottom:30px; font-family:ibms;" >
         <span>바나다에 어서오세요.</span>   
     	</div>
        
        
        <div>
            <button onclick="location.href='main.jsp'" 
            style="cursor:pointer; font-family:ibm; width: 200px; height: 50px; border-radius:25px; font-size:20px; border:none; background:#ffc107; color:white; margin-bottom:15px;">메인으로 가기</button>
        </div>
