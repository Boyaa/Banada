...
<body style="
    ...
    <section style="border-radius:25px; border:2px solid #eaeaea; padding:50px;">
         ...
         <div>
         <h1 style="font-family:ibm; font-size:40px; color:#ffc107;">가입을 축하합니다!</h1>  
         </div>
       
        <div style="font-size:20px; margin-bottom:30px; font-family:ibms;" >
         <span>따뜻한 나눔, 새로운 경험 <br> 이제 바나다로 나눠보세요.</span>   
     	</div>
        
        <div>
            <button onclick="location.href='login.jsp'" 
            style="cursor:pointer; font-family:ibm; width: 200px; height: 50px; border-radius:25px; font-size:20px; border:none; background:#ffc107; color:white; margin-bottom:15px;">로그인 하러가기</button>
        </div>
        <div>
