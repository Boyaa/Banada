...
import com.smhrd.domain.Object;
import com.smhrd.domain.ObjectDAO;


public class ObjectCon extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Object product = new Object(pd_title, pd_content, pd_content, pd_price, pd_cate, pd_option);
